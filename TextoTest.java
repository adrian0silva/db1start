...
public class TextoTest {
	...
	public void retornarAlunoOuAluna() {
		Texto txt = new Texto();
		String texto = txt.retornarAluno("Adriano da silva");
		System.out.println(texto);
		Assert.assertEquals("ANO", texto);
	}
	...
	@Test
	public void retornarVogais() {
		Texto txt = new Texto();
		String texto = txt.textoVogais("adriano");
		System.out.println(texto);
		Assert.assertEquals("aiao", texto);
	}
	//12 - FUM que receba um texto e devolva ele invertido
	@Test
	public void deveInverter() {
		Texto txt = new Texto();
		String texto = txt.inversaoDeString("adriano");
		System.out.println(texto);
		int n = texto.indexOf("n");
